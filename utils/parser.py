...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default=r"",
                        help='path to model file, i.e. yolo11n.pt, yolov8n.yaml')
    parser.add_argument('--data_path', type=str, default='./datasets', help='path to datasets file')
    parser.add_argument('--data', type=str, default='AI-TOD.yaml', help='path to data file, i.e. coco8.yaml')
    ...
    parser.add_argument('--show_labels', action='store_true', default=True, help='show prediction labels, i.e. person')
    parser.add_argument('--show_conf', action='store_true', default=True, help='show prediction confidence, i.e. 0.99')
    parser.add_argument('--show_boxes', action='store_true', default=True, help='show prediction boxes')
    ...
    parser.add_argument('--simplify', action='store_true', default=True, help='ONNX: simplify model using onnxslim')
