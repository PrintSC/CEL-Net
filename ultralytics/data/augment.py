...
class BaseMixTransform:
    ...
    def __call__(self, labels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Examples:
            ...
            >>> result_our = transform({"image": img, "bboxes": boxes, "cls": classes})
        """
...
class Mosaic(BaseMixTransform):
    ...
    def _mosaic3(self, labels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Examples:
            ...
            ... }
            >>> result_our = mosaic._mosaic3(labels)
            >>> print(result_our["img"].shape)
            (640, 640, 3)
        """
        mosaic_labels = []
        s = self.imgsz
    ...
    def _mosaic4(self, labels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Examples:
            ...
            ... }
            >>> result_our = mosaic._mosaic4(labels)
            >>> assert result_our["img"].shape == (1280, 1280, 3)
        """
        mosaic_labels = []
        s = self.imgsz
    ...
    def _cat_labels(self, mosaic_labels: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        Examples:
            ...
            >>> result_our = mosaic._cat_labels(mosaic_labels)
            >>> print(result_our.keys())
...
class RandomPerspective:
    ...
    Examples:
        ...
        >>> result_our = transform(labels)
        >>> transformed_image = result_our["img"]
        >>> transformed_instances = result_our["instances"]
    """
    ...
    def __init__(
        ...
        Examples:
            ...
            >>> result_our = transform(labels)  # Apply random perspective to labels
        """
    ...
    def __call__(self, labels: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Examples:
            ...
            ... }
            >>> result_our = transform(labels)
            >>> assert result_our["img"].shape[:2] == result_our["resized_shape"]
        """
...
class RandomFlip:
    ...
    Examples:
        ...
        >>> result_our = transform({"img": image, "instances": instances})
        >>> flipped_image = result_our["img"]
        >>> flipped_instances = result_our["instances"]
    """
...
class LetterBox:
    ...
    Examples:
        ...
        >>> result_our = transform(labels)
        >>> resized_img = result_our["img"]
        >>> updated_instances = result_our["instances"]
    """
    ...
    def __call__(self, labels: Dict[str, Any] = None, image: np.ndarray = None) -> Union[Dict[str, Any], np.ndarray]:
        ...
        Examples:
            ...
            >>> result_our = letterbox(labels={"img": np.zeros((480, 640, 3)), "instances": Instances(...)})
            >>> resized_img = result_our["img"]
            >>> updated_instances = result_our["instances"]
        """
        if labels is None:
