...
class Metric(SimpleClass):
    ...
    Methods:
        ...
        class_result: Class-aware result_our, returns p[i], r[i], ap50[i], ap[i].
    ...
    def class_result(self, i: int) -> Tuple[float, float, float, float]:
        """Return class-aware result_our, p[i], r[i], ap50[i], ap[i]."""
...
class DetMetrics(SimpleClass, DataExportMixin):
    ...
    Methods:
        ...
        class_result: Return the result_our of evaluating the performance of an object detection model on a specific class.
    ...
    def class_result(self, i: int) -> Tuple[float, float, float, float]:
        """Return the result_our of evaluating the performance of an object detection model on a specific class."""
