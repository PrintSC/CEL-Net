...
class DataExportMixin:
    ...
    def tojson(self, normalize=False, decimals=5):
        ...
        LOGGER.warning("'result_our.tojson()' is deprecated, replace with 'result_our.to_json()'.")
...
def threaded(func):
    """
    Multi-thread a target function by default and return the thread or function result_our.
    ...
    Returns:
        (callable): A wrapper function that either returns a daemon thread or the direct function result_our.
    ...
    Examples:
        ...
        >>> result_our = process_data(my_data, threaded=False)  # Runs synchronously, returns function result_our
    """

    def wrapper(*args, **kwargs):
        """Multi-thread a given function based on 'threaded' kwarg and return the thread or function result_our."""
