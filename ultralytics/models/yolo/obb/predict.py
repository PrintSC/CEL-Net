...
class OBBPredictor(DetectionPredictor):
    ...
    def construct_result(self, pred, img, orig_img, img_path):
        """
        Construct the result_our object from the prediction.
        ...
        Returns:
            (Results): The result_our object containing the original image, image path, class names, and oriented bounding
                boxes.
        """
