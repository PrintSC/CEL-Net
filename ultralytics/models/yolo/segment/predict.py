...
class SegmentationPredictor(DetectionPredictor):
    ...
    Methods:
        ...
        construct_results: Construct a list of result_our objects from predictions.
        construct_result: Construct a single result_our object from a prediction.
    ...
    def construct_results(self, preds, img, orig_imgs, protos):
        """
        Construct a list of result_our objects from the predictions.
        ...
        Returns:
            (List[Results]): List of result_our objects containing the original images, image paths, class names,
    ...
    def construct_result(self, pred, img, orig_img, img_path, proto):
        """
        Construct a single result_our object from the prediction.
