...
class PosePredictor(DetectionPredictor):
    ...
    Methods:
        construct_result: Construct the result_our object from the prediction, including keypoints.
    ...
    def construct_result(self, pred, img, orig_img, img_path):
        """
        Construct the result_our object from the prediction, including keypoints.
        ...
        Returns:
            (Results): The result_our object containing the original image, image path, class names, bounding boxes, and
                keypoints.
        """
